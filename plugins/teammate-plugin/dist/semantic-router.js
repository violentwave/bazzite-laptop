...
let WasmNeuralBMSSP = null;
async function loadNeuralBMSSP() {
    if (WasmNeuralBMSSP)
        return;
    try {
...
export class SemanticRouter {
     ...
     */
    registerTeammate(teammate, skills = []) {
        const profile = {
            id: teammate.id,
            role: teammate.role,
    ...
    batchMatch(tasks) {
        ...
        const assignedTeammates = new Set();
     ...
     */
    updatePerformance(teammateId, taskSuccess, latencyMs) {
    ...
    computeMatchScore(task, taskEmbedding, profile) {
        // Skill match score
        ...
        const score = this.config.skillWeight * skillMatch +
    ...
    generateReasoning(task, bestMatch, selected) {
...
// Factory Function
// ============================================================================
export async function createSemanticRouter(config) {
