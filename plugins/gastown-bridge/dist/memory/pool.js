...
export class ObjectPool {
    ...
    release(obj) {
        ...
        else if ('reset' in obj && typeof obj.reset === 'function') {
            obj.reset();
        }
     ...
     */
    preWarm(count) {
        const toCreate = Math.min(count, this.config.maxSize > 0 ? this.config.maxSize - this.pool.length : count);
 ...
 */
export const beadPool = new ObjectPool(() => new PooledBead(), {
    initialSize: 100,
    maxSize: 10000,
    objectSizeBytes: 512,
 ...
 */
export const formulaPool = new ObjectPool(() => new PooledFormula(), {
    initialSize: 10,
    maxSize: 500,
 ...
 */
export const stepPool = new ObjectPool(() => new PooledStep(), {
    initialSize: 50,
    maxSize: 5000,
    objectSizeBytes: 256,
    preWarm: false,
 ...
 */
export const convoyPool = new ObjectPool(() => new PooledConvoy(), {
    initialSize: 10,
    maxSize: 200,
    objectSizeBytes: 768,
    preWarm: false,
 ...
 */
export const moleculePool = new ObjectPool(() => new PooledMolecule(), {
    initialSize: 50,
    maxSize: 5000,
    objectSizeBytes: 384,
    preWarm: false,
 ...
 */
export function getTotalMemorySaved() {
    return Object.values(allPools).reduce((total, pool) => total + pool.getStats().memorySaved, 0);
}
/**
 * Clear all pools
 */
 ...
 */
export function preWarmAllPools() {
