 ...
 */
export type TestType = 'unit' | 'integration' | 'e2e' | 'property' | 'mutation' | 'fuzz' | 'api' | 'performance' | 'security' | 'accessibility' | 'contract' | 'bdd';
/**
 ...
 */
export type TestFramework = 'vitest' | 'jest' | 'mocha' | 'pytest' | 'junit' | 'xunit' | 'nunit' | 'playwright' | 'cypress';
/**
 ...
 */
export type ChaosFailureType = 'network-latency' | 'network-partition' | 'cpu-stress' | 'memory-pressure' | 'disk-failure' | 'process-kill';
/**
 * Compliance standards for security audits
 */
export type ComplianceStandard = 'owasp-top-10' | 'sans-25' | 'pci-dss' | 'hipaa' | 'gdpr' | 'soc2';
/**
 ...
 * Coverage gap types
 */
export type CoverageGapType = 'uncovered-lines' | 'uncovered-branches' | 'uncovered-functions' | 'low-branch-coverage' | 'missing-edge-cases';
/**
 ...
 */
export type BoundedContext = 'test-generation' | 'test-execution' | 'coverage-analysis' | 'quality-assessment' | 'defect-intelligence' | 'requirements-validation' | 'code-intelligence' | 'security-compliance' | 'contract-testing' | 'visual-accessibility' | 'chaos-resilience' | 'learning-optimization';
/**
 * V3 Domain mapping for context integration
 */
export type V3Domain = 'Security' | 'Core' | 'Memory' | 'Integration' | 'Coordination';
/**
 ...
 */
export type QEWorkerType = 'test-executor' | 'coverage-analyzer' | 'security-scanner';
/**
 * Worker definition
 */
 ...
 * Hook event type
 */
export type QEHookEvent = 'pre-test-execution' | 'pre-security-scan' | 'post-test-execution' | 'post-coverage-analysis' | 'post-security-scan';
/**
 * Hook priority
 */
