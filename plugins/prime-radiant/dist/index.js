...
export { 
// Base schemas
EmbeddingVectorSchema, EmbeddingVectorsSchema, AdjacencyMatrixSchema, CoherenceEnergySchema, ThresholdSchema, 
// Coherence schemas
CoherenceCheckInputSchema, CoherenceCheckResultSchema, CoherenceThresholdsSchema, 
// Spectral schemas
SpectralAnalysisTypeSchema, SpectralAnalyzeInputSchema, SpectralAnalysisResultSchema, 
// Causal schemas
CausalGraphSchema, CausalInferInputSchema, CausalInferenceResultSchema, 
// Consensus schemas
AgentStateSchema, ConsensusVerifyInputSchema, ConsensusResultSchema, 
// Topology schemas
PointCloudSchema, QuantumTopologyInputSchema, PersistencePointSchema, TopologyResultSchema, 
// Memory schemas
MemoryEntrySchema, MemoryGateInputSchema, CoherenceActionSchema, MemoryGateResultSchema, 
// Configuration schemas
CoherenceConfigSchema, SpectralConfigSchema, CausalConfigSchema, PrimeRadiantConfigSchema, 
// HoTT schemas
HottVerificationInputSchema, HottProofResultSchema, 
// Morphism schemas
MorphismInputSchema, MorphismResultSchema, 
// Validation functions
validateCoherenceInput, validateSpectralInput, validateCausalInput, validateConsensusInput, validateTopologyInput, validateMemoryGateInput, validateConfig, safeValidate, } from './schemas.js';
// ============================================================================
// Factory Functions
// ============================================================================
 ...
 */
export function createPrimeRadiantPlugin(config) {
