...
export const MemoryGateInputSchema = z.object({
    ...
    contextEmbeddings: EmbeddingVectorsSchema.optional().describe('Existing context embeddings to check against'),
