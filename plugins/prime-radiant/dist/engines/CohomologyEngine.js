...
export class CohomologyEngine {
     ...
     */
    async computeLaplacianEnergy(sheaf) {
     ...
     */
    async detectContradictions(vectors) {
        if (vectors.length < 2) {
            return [];
        }
        const violations = [];
     ...
     */
    async computeSheafLaplacianEnergy(vectors) {
        if (this.wasmModule) {
...
//# sourceMappingURL=CohomologyEngine.js.map