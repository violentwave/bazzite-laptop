...
export class QuantumEngine {
     ...
     */
    async computeBettiNumbers(complex) {
     ...
     */
    async persistenceDiagram(filtration) {
     ...
     */
    async computeHomologyClasses(complex) {
     ...
     */
    async computeTopology(points, maxDimension = 2) {
     ...
     */
    countConnectedComponents(complex) {
        const n = complex.vertices.length;
        if (n === 0)
            return 0;
     ...
     */
    computePersistenceDiagramJS(filtration) {
        const points = [];
     ...
     */
    parsePersistenceDiagram(result) {
        const points = [];
     ...
     */
    buildRipsComplex(points, maxDimension) {
     ...
     */
    buildFiltration(complex, points) {
        const values = [];
...
//# sourceMappingURL=QuantumEngine.js.map